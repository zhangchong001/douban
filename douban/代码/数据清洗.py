...
book = xlrd.open_workbook("book_list-大数据-C语言-python-web-java.xlsx")
sheetNames = book.sheet_names()
#建立一个MySQL连接
conn = pymysql.connect(
        host='localhost', 
        user='root', 
        passwd='123456',  # Your MySQL password
        db='doubanspider',
        port=3306,  
        charset='utf8'
        )
...
cur = conn.cursor()
# 创建插入SQL语句
dict = {'大数据':'data', 'C语言':'language', 'python':'python', 'web':'web', 'java':'java', 'Sheet':'sheet'}
